...
namespace Assets.Scripts.Player
{
    public class PlayerMovement
    {
        ...
        /// <param name="axisName">Es un String que corresponde a la tecla de salto del jugador.</param>
        public void Jump(Rigidbody2D rigidBody, bool isGrounded, String axisName) 
        {
            if (isGrounded)
            {
        ...
        public bool IsActionChangeColorKeyDown()
        {
